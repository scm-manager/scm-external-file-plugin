...
Shows files in SCM-Manager which are stored externally

## Usage

Find out how this plugin works on the [plugin documentation page](https://scm-manager.org/plugins/scm-external-file-plugin/docs/).
